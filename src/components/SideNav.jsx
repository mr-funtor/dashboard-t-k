...
const SideNav=()=>{
    return(
        <nav className="w-[300px] px-8 py-4 h-screen ">
            <h1 className="text-6xl font-bold mb-[70px]">RETRO </h1>
            
            <ul>
                <li className="flex px-6 py-1 bg-[#edeffa] rounded-md mb-3">
                    <i><FontAwesomeIcon icon={faBarChart} /></i>
                    
                    <p className="ml-4">Dashboard</p>
                </li>
                
                <li className="flex px-6 py-1 rounded-md mb-3">
                    <i><FontAwesomeIcon icon={faBarChart} /></i>
                ...
                <li className="flex justify-between px-6 py-1 rounded-md mb-3">
                    <div className="flex">
                    <i><FontAwesomeIcon icon={faBarChart} /></i>
